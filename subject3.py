...
#subject3은 15개의 열과 257개의 행으로 이루어져 있다.
...
plt.scatter(x=df['Vote_time_as_number'], y=df['mean.Solar_60'], color='red', alpha=0.4) #그림을 보면 600~1000 즉, 10시~17시 해가 떠있을때 Solar가 큰것을 볼 수 있음 
...
df_subject3.shape #총 4개의 열과 146개의 행으로 이루어져 있음
###############################################################################################
#4. model 만들기
##4-1. 데이터 분리(train, test='therm_sens')
from sklearn.model_selection import train_test_split
X = df_subject3.iloc[:, :3]
y = df_subject3.iloc[:, 3]
