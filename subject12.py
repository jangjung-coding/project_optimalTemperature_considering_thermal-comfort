...
#subject12은 개의 15열과 156개의 행으로 이루어져 있다.
...
결측치 열 9개
    'grad.Temperature_60', 
    'grad.Humidity_60',
->'Temperature'은 2주 사이에 큰 차이가 없어 평균값으로 결측치 처리
    'grad.Solar_60',
...
df_subject12.shape #총 4개의 열과 154개의 행으로 이루어져 있음
###############################################################################################
#4. model 만들기
##4-1. 데이터 분리(train, test='therm_sens')
from sklearn.model_selection import train_test_split
X = df_subject12.iloc[:, :3]
y = df_subject12.iloc[:, 3]
