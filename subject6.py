...
#subject6은 30개의 열과 222개의 행으로 이루어져 있다.
...
plt.boxplot(df[environmental_features_include_solar]) # 'Solar'에서 이상치가 많이 발견됨. 이는 subject6 측정 계절이  12월로 Solar그래프(73번 줄)을 보면 습도가 높고 구름이 많이 낀 날이 많았을 것으로 추정할 수 있음
