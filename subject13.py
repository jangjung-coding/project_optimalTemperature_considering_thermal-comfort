...
#subject13은 15개의 열과 189개의 행으로 이루어져 있다.
...
plt.show() # 결측치가 다른 subject에 비해 많이 적음
## df으로 결측치 직접 확인
...
df_subject13.shape #총 5개의 열과 189개의 행으로 이루어져 있음
###############################################################################################
#4. model 만들기
##4-1. 데이터 분리(train, test='therm_sens')
from sklearn.model_selection import train_test_split
X = df_subject13.iloc[:, :3]
y = df_subject13.iloc[:, 3]
