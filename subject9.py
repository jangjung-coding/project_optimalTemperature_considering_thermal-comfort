...
#subject9은 24개의 열과 233개의 행으로 이루어져 있다.
...
df[['mean.Solar_60', 'grad.Solar_60', 'sd.Solar_60']].isnull().sum() 
'''
계속해서 
mean.Solar_60    9
grad.Solar_60    9
...
df[['mean.Solar_60', 'grad.Solar_60', 'sd.Solar_60']].tail(10) # 뒤에서 9개의 행에서 지속적으로 결측치가 나옴 -> 제거
